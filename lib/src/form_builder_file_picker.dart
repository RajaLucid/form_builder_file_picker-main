...
class FormBuilderFilePicker extends FormBuilderField<List<PlatformFile>> {
  ...
  final bool showDocumentScannnerDocumentExtension;
  ...
  FormBuilderFilePicker({
    ...
    required this.showDocumentScannnerDocumentExtension,
    this.onFieldClicked,
  }) : super(
          key: key,
  ...
  Future<void> pickFiles(FormFieldState<List<PlatformFile>?> field,
    ...
    if (widget.onFieldClicked != null) {
      ...
      if ((isAllowedExtensionContainsAnyImageFileExtension() &&
          widget.showImagePickerOnImageExtensions)&&(isAllowedExtensionContainsAnyImageFileExtension() &&
          widget.showDocumentScannnerDocumentExtension==false ) ) {
        await showModalBottomSheet<void>(
          ...
          builder: (_) {
            return ImageSourceBottomSheet(
              ...
              onDocumentSelected: (docFiles)async{
                state.requestFocus();
                var newImages = <PlatformFile>[];
      ...
      }else  if ((isAllowedExtensionContainsAnyImageFileExtension() &&
          widget.showDocumentScannnerDocumentExtension )||(isAllowedExtensionContainsAnyImageFileExtension() ||
        ...
        await showModalBottomSheet<void>(
          ...
          builder: (_) {
            return ImageSourceBottomSheet(
              ...
              maxWidth: 400,
              preventPop: true,
              isDocScanner:widget.showDocumentScannnerDocumentExtension,
              remainingImages: _remainingItemCount,
              imageQuality: 100,
              preferredCameraDevice: CameraDevice.rear,
              bottomSheetPadding: EdgeInsets.zero,
